...
<!-- Somethings removed here -->
              <!-- <div class="col s2 m6 l6"><a class="btn waves-effect waves-light breadcrumbs-btn right" href="#!"><i class="material-icons hide-on-med-and-up">add_circle</i><span class="hide-on-small-only">Add Category</span></a>
              </div> -->
    ...
    <input type="hidden" name="order[]" value="{{ $project->id }}">
      <div class="card">
        <div class="card-image">
          <img src="{{ url($project->image) }}" alt="{{ $project->name }}" style="height: 15em;" />
        </div>
