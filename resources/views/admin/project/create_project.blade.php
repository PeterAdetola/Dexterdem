          ...
          <form method="POST" action="{{ route('save.project') }}" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col s12 m12 l6 mt-3">
                  <input name="image" type="file" id="input-file-now-custom-2" class="dropify" data-height='450' />  
                  @error('image')
        ...
        <legend>&nbsp;&nbsp;&nbsp;Project Details&nbsp;&nbsp;&nbsp;</legend>
                <div class="row">
                  <div class="col s12 m6 input-field mt-1">
                    <input id="location" name="location" type="text" class="validate" data-error=".errorTxt2" />
                  ...
                  <div class="col s12 m6 input-field mt-1">
                    <input id="year" name="year" type="text" class="validate" data-error=".errorTxt2" />
    ...
    <div class="row">
      ...
      <div class="progress collection mb-2">
        ...
        border:2px #ebebeb solid"></div>
                ...
                <button  id="createProjectBtn" type="submit" class="modal-action waves-effect waves-red btn-large right mt-2">Save</button>
