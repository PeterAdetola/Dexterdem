          ...
          <form method="POST" action="{{ route('save.service') }}" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col s12 m12 l6 mt-3">
                  <input name="image" type="file" id="input-file-now-custom-2" class="dropify" data-height='250' />  
                  @error('image')
                  <small class="errorTxt3  red-text">{{ $message }}*</small>
                  @enderror   

                  <small class="errorTxt3  grey-text">Upload service image in JPG (612 x 344)</small>
              </div>
