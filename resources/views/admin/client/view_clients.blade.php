...
<div class="row"> 
  <div class="col s12 m12 l8">
    <form method="POST" action="{{ route('sort.client') }}">
            @csrf
  ...
  @foreach($clients as $client)
    ...
    {{--@include('admin.client.modals.edit-client-modal')--}}
    ...
    @else
      <li>
         ...
         <div class="collapsible-body">
            <span>To create client, click the plus at the bottom right corner of the page, provide the required details to create a new client</span>
    ...
    @endif
      ...
      <div class="progress collection border mt-5">
        <div id="sort-client-preloader" class="indeterminate"  style="display:none; 
...
Sortable.create(simpleList, {
  ...
  <div style="bottom: 50px; right: 19px;" class=" fixed-action-btn direction-top"><a href="#create-client-modal" class="modal-trigger btn-floating btn-large gradient-45deg-black-grey gradient-shadow"><i class="material-icons">add</i></a>
  </div>

    @include('admin.client.modals.create-client-modal')
...
<!-- users view ends -->
  ...
  <script>
    ...
    document.getElementById("saveOrderButton").addEventListener("click", function() {
      var preloader = document.getElementById("sort-client-preloader");
